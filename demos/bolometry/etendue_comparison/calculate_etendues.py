...
plt.figure()
plt.plot(list(range(len(aug_etendues))), aug_etendues, label='Analytic etendue')
plt.plot(list(range(len(cherab_etendues))), cherab_etendues, '.', label='ray-traced etendue')
