...
# emiss77 = load_emissivity_phantom('AUG_emission_phantom_001')
...
inverted_emiss_vector, rnorm = invert_regularised_nnls(vol_weight_matrix, obs_power, alpha=0.0000000001)
