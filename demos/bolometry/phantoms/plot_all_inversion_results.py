...
for line in lines[1:]:
    ...
    los_iter.append(row[4])
    vol_rhos.append(row[6])
    vol_iter.append(row[7])
    los_rhos_1000.append(row[9])
    los_iter_1000.append(row[10])
    vol_rhos_1000.append(row[12])
    vol_iter_1000.append(row[13])
    los_rhos_80.append(row[15])
    vol_rhos_80.append(row[18])
